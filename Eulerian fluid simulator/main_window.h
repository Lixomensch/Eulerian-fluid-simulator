...
struct menu
{
    ...
    menu(sf::RenderWindow& window, sf::Font& font) {
        rect.setSize(sf::Vector2f(window.getSize().x, 50.f)); // Ajuste conforme necessário
        rect.setFillColor(sf::Color::White);
        rect.setPosition(0.f, 0.f);

        // Posicionamento do botão relativo ao retângulo do menu
        sf::Vector2f buttonSize(100.f, rect.getSize().y - 10.f);
        sf::Vector2f buttonPosition(10.f, 5.f); // Ajuste conforme necessário
